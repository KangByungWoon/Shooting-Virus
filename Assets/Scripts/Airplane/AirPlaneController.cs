...
public class AirPlaneController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        main_camera.transform.rotation = Quaternion.Slerp(transform.rotation,
        Quaternion.Euler(Mathf.Clamp(xAngel, -15, 15), 0, Mathf.Clamp(zAngle, -15f, 15f)), Time.deltaTime * 5);
        ...
        if (HorizontalInput != 0)
        {
            ...
            xPos += HorizontalInput * Time.deltaTime * 50;
        ...
        if (VerticalInput != 0)
        {
            ...
            TargetPoint = StartPosition + new Vector3(xPos, VerticalInput * 10, 0);
        }
        else
        {
            xAngel = 0;
