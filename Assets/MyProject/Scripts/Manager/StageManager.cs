    ...
    private IEnumerator SpawnCoroutine()
    {
        while (true)
        {
            ...
            for (int i = 0; i <= randomspawn; i++)
            {
                ...
                {
                    case 0:
                        ObjectPoolMgr.Instance.GetObject("Bacteria", new Vector3(Random.Range(-30, 30), Random.Range(10, 30), -10));
                        break;
                    case 1:
                        ObjectPoolMgr.Instance.GetObject("Germ", new Vector3(Random.Range(-30, 30), Random.Range(10, 30), -10));
                        break;
                    case 2:
                        ObjectPoolMgr.Instance.GetObject("Cancer_Cells", new Vector3(Random.Range(-30, 30), Random.Range(10, 30), -10));
                        break;
                    case 3:
                        ObjectPoolMgr.Instance.GetObject("Virus", new Vector3(Random.Range(-30, 30), Random.Range(10, 30), -10));
                        break;
                }
